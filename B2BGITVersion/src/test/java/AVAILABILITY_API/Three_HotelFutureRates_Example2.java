...
public class Three_HotelFutureRates_Example2 {

	@Test(priority = 1)
	public void HotelFutureRates() throws Exception {
		
		FileInputStream fileinputstream = new FileInputStream("../B2B/AVAILABILITYAPI/Three_HotelFutureRates_Example2.xml");
